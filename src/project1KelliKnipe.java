...
public class project1KelliKnipe {
	...
	public static void main(String[] args) {
		...
		String outputAge = "balls";
		String outputMonth = "piss";
		String outputColor = "ass";
		String outputSiblings = "garbage";
		...
		while (programExit < 2) {
			...
			// Example: Pisslord Fuckwraith

			while (questionExit == 0 && helpSwitch == 0 && quitSwitch == 0) {
				System.out.println("Enter your full name");
				System.out.print("> ");
				userInput = input.nextLine();
				if (!userInput.equals(smallQuit) && !userInput.equals(largeQuit) && !userInput.equals(smallHelp)
						&& !userInput.equals(largeHelp)) {
					userName = userInput;
					questionExit = 1;
				} else if (userInput.equals(smallHelp) || userInput.equals(largeHelp)) {
					++helpSwitch;
